...
export class GameScene extends Phaser.Scene {
        ...
        this.time.delayedCall(this.nextSpawnTime, () => {
            ...
            this.spawnTimer = this.time.addEvent({
                delay:
                    ...
                    (SPAWN_CONFIG.maxInterval - SPAWN_CONFIG.minInterval) * 0.5,
    ...
    private spawnEnemy() {
        ...
        if (
            layerConfig.bossChance > 0 &&
            Math.random() < layerConfig.bossChance
        ) {
            this.spawnBoss();
            return;
        }
        ...
        const availableEnemies = [...layerConfig.enemies] as Array<
